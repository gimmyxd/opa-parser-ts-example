(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.OpaCompileResponseParser = {}));
    ...
    ***************************************************************************** */
    ...
    var RegoRule = /** @class */ (function () {
        function RegoRule(options) {
            ...
            if (((_a = this.expressions) === null || _a === void 0 ? void 0 : _a.length) &&
                this.expressions.findIndex(function (exp) { return !exp.hasNoResolvableRef; }) === -1) {
         ...
         * @memberof RegoRule
         */
        RegoRule.prototype.removeDuplicateExpressions = function () {
            var _a;
            if (!((_a = this === null || this === void 0 ? void 0 : this.expressions) === null || _a === void 0 ? void 0 : _a.length)) {
                return;
            }
            var expSet = new Set();
            this.expressions = this.expressions.filter(function (exp) {
                var orgSetLength = expSet.size;
         ...
         * @memberof RegoRule
         */
        RegoRule.prototype.isImpossible = function () {
            var _a;
            if (!((_a = this === null || this === void 0 ? void 0 : this.expressions) === null || _a === void 0 ? void 0 : _a.length)) {
                return false;
            }
            var nonNegatedExpSet = new Set();
            var negatedExps = this.expressions.filter(function (exp) {
                if (exp.isNegated) {
                    return true;
                }
                else {
            ...
            for (var _i = 0, negatedExps_1 = negatedExps; _i < negatedExps_1.length; _i++) {
                var exp = negatedExps_1[_i];
        ...
        RegoRule.prototype.clone = function (options) {
            if (options === void 0) { options = {}; }
            var regoRule = new RegoRule(__assign({ name: this.name, fullName: this.fullName, isDefault: this.isDefault, value: this.value, isCompleteEvaluated: this.isCompleteEvaluated, expressions: this.expressions.map(function (e) { return e.clone(); }), parser: this.parser }, options));
         ...
         * @memberof RegoRule
         */
        RegoRule.prototype.evaluate = function () {
            var _a;
         ...
         * @memberof RegoRule
         */
        RegoRule.prototype.isResolvable = function () {
            if (!this.isCompleteEvaluated) {
                this.evaluate();
            }
         ...
         * @memberof RegoRule
         */
        RegoRule.prototype.toHumanReadableString = function () {
            if (this.isCompleteEvaluated) {
                if (this.isMatched) {
                ...
                var parts = this.expressions.map(function (e) {
                    return e.toHumanReadableString();
                });
                return parts.join(" AND \n");
            }
        };
        RegoRule.prototype.toData = function () {
            return {
                default: this.isDefault,
                value: this.value,
                fullName: this.fullName,
                name: this.name,
                expressions: this.expressions.map(function (exp, idx) { return exp.toData(idx); })
            };
        };
        RegoRule.prototype.toJson = function () {
            return JSON.stringify(this.toData());
        };
        RegoRule.prototype.toConciseData = function () {
            return {
                default: this.isDefault,
                value: this.value,
                fullName: this.fullName,
                name: this.name,
                expressions: this.expressions.map(function (exp) { return exp.toConciseData(); })
            };
        };
        RegoRule.prototype.toConciseJSON = function () {
         ...
         * @memberof RegoRule
         */
        RegoRule.parseFromData = function (r, packageName, parser) {
            var ruleName = r.head && r.head.name ? r.head.name : "";
            var ruleFullName = [packageName, ruleName].join(".");
            var ruleIsDefault = r.default === true;
            var ruleValue = r.head && r.head.value && !_.isUndefined(r.head.value.value)
                ? r.head.value.value
                : true;
            var ruleOptions = {
                name: ruleName,
            ...
            var regoRule = new RegoRule(ruleOptions);
            return regoRule;
        };
        RegoRule.createExpressionsFromRuleBodyData = function (data, parser) {
            if (!_.isArray(data) || !data.length) {
                throw new Error("Encountered empty rule body.");
            }
            return data.map(function (expData) { return RegoExp.parseFromData(expData, parser); });
        };
        RegoRule.randomRuleName = function (prefix) {
            return (prefix + Math.random()).replace(".", "_");
        };
        RegoRule.createFromValue = function (val, parser) {
            var ruleName = RegoRule.randomRuleName("fixed_value_rule_");
            return new RegoRule({
                isDefault: false,
                name: ruleName,
                fullName: ruleName,
    ...
    var RegoTerm = /** @class */ (function () {
        function RegoTerm(type, value, parser) {
            /**
        ...
        RegoTerm.prototype.clone = function () {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.asString = function () {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.isRef = function () {
            if (this.value instanceof RegoRef)
                return true;
            return false;
        };
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.getRef = function () {
            if (this.isRef()) {
                return this.value;
            }
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.hasCollectionLookup = function () {
            if (!this.isRef())
                return false;
            var ref = this.getRef();
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.isSimpleCollectionLookup = function () {
            if (!this.isRef())
                return false;
            var ref = this.getRef();
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.isResolveAsCollectionValue = function () {
            if (!this.isRef())
                return false;
            var ref = this.getRef();
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.fullRefString = function (removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
            if (this.value instanceof RegoRef) {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.refString = function (removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
            if (this.value instanceof RegoRef) {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.asOperator = function () {
            if (this.value instanceof RegoRef) {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.isOperator = function () {
            if (this.value instanceof RegoRef) {
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.getValue = function () {
            if (this.hasNoResolvableRef) {
                return undefined;
            }
            if (!this.isRef()) {
                ...
                if (this.isOperator()) {
                    ...
                    var fullName = this.fullRefString();
         ...
         * @memberof RegoTerm
         */
        RegoTerm.prototype.isValueResolvable = function () {
            if (this.hasNoResolvableRef) {
                return false;
            }
            if (!this.isRef()) {
        ...
        RegoTerm.prototype.toData = function () {
            if (this.isRef()) {
        ...
        RegoTerm.prototype.toJson = function () {
            return JSON.stringify(this.toData());
        };
        RegoTerm.prototype.toConciseData = function () {
            if (this.isRef()) {
                return {
                    isRef: true,
        ...
        RegoTerm.prototype.toConciseJSON = function () {
            return JSON.stringify(this.toConciseData());
        };
        RegoTerm.parseFromData = function (data, parser) {
            if (data.type === "ref") {
     ...
     * @class RegoExp
     */
    var RegoExp = /** @class */ (function () {
        function RegoExp(terms, isNegated, isCompleteEvaluated, value, parser) {
            if (isNegated === void 0) { isNegated = false; }
            if (isCompleteEvaluated === void 0) { isCompleteEvaluated = false; }
            ...
            if (((_a = this === null || this === void 0 ? void 0 : this.terms) === null || _a === void 0 ? void 0 : _a.length) &&
                this.terms.findIndex(function (item) { return !item.hasNoResolvableRef; }) === -1) {
                this.hasNoResolvableRef = true;
            }
        }
        RegoExp.prototype.clone = function () {
            var regoExp = new RegoExp(this.terms.map(function (t) { return t.clone(); }), this.isNegated, this.isCompleteEvaluated, this.value, this.parser);
            return regoExp;
        };
        /**
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.termsAsString = function () {
            return this.terms.map(function (t) { return t.asString(); }).join(" ");
        };
        /**
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.asString = function () {
            if (this.isNegated) {
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.toHumanReadableString = function () {
            if (this.terms.length === 1) {
                var value = this.terms[0].getValue();
                var parts = [];
                if (this.isNegated)
                    parts.push("NOT");
                ...
                var _a = this.toOperatorOperandsArray(), operator = _a[0], operands = _a[1];
                var parts = [];
                if (operands[0].isRef()) {
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.getValue = function () {
            this.evaluate();
            if (!this.isCompleteEvaluated)
                return undefined;
            if (this.isNegated) {
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.isMatched = function () {
            if (!this.isResolvable()) {
                return undefined;
            }
            var isMatched = this.value === false || _.isUndefined(this.value) ? false : true;
            if (this.isNegated) {
                return !isMatched;
            }
            else {
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.isResolvable = function () {
            if (!this.isCompleteEvaluated) {
                this.evaluate();
            }
            return this.isCompleteEvaluated;
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.toOperatorOperandsArray = function () {
         ...
         * @memberof RegoExp
         */
        RegoExp.prototype.evaluate = function () {
            if (this.hasNoResolvableRef) {
                return this;
            }
            if (this.isCompleteEvaluated) {
            ...
            if (this.terms.length === 0) {
                ...
                var operandsValues = operands.map(function (op) { return op.getValue(); });
                if (operandsValues.findIndex(function (v) { return typeof v === "undefined"; })) ;
                var value = null;
                switch (operator) {
                    case "=":
        ...
        RegoExp.prototype.toData = function (index, ignoreIndex, ignoreNegated) {
            if (index === void 0) { index = 0; }
            if (ignoreIndex === void 0) { ignoreIndex = false; }
            if (ignoreNegated === void 0) { ignoreNegated = false; }
            var terms = this.terms.map(function (term) { return term.toData(); });
        ...
        RegoExp.prototype.toJSON = function (index, ignoreIndex, ignoreNegated) {
            if (index === void 0) { index = 0; }
            if (ignoreIndex === void 0) { ignoreIndex = false; }
            if (ignoreNegated === void 0) { ignoreNegated = false; }
            return JSON.stringify(this.toData(index, ignoreIndex, ignoreNegated));
        };
        RegoExp.prototype.toConciseData = function () {
            var data;
            if (this.terms.length === 1) {
                var term = this.terms[0];
                data = {
                ...
                data = {
                    negated: this.isNegated,
                    operator: operator,
                    operands: operands.map(function (item) { return item.toConciseData(); })
                };
            }
            return data;
        };
        RegoExp.prototype.toConciseJSON = function () {
            return JSON.stringify(this.toConciseData());
        };
        RegoExp.parseFromData = function (expData, parser) {
            var isNegated = expData.negated === true;
            ...
            var terms = termsData.map(function (termData) {
                return RegoTerm.parseFromData(termData, parser);
            });
            var exp = new RegoExp(terms, isNegated, false, null, parser);
            exp.evaluate();
            return exp;
        };
        return RegoExp;
    ...
    var RegoRef = /** @class */ (function () {
        ...
        RegoRef.prototype.clone = function () {
            return new RegoRef(this.parts.map(function (p) { return (__assign({}, p)); }));
        };
        RegoRef.prototype.toData = function () {
            return {
                type: "ref",
                value: this.parts
            };
        };
        RegoRef.prototype.toJson = function () {
            return JSON.stringify(this.toData());
        };
        RegoRef.parseFromData = function (data) {
            if (data.type === "ref") {
        ...
        RegoRef.convertToFullRefString = function (parts) {
            return new RegoRef(parts).fullRefString();
        };
        RegoRef.prototype.removeAllPrefixs = function (str, removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
        ...
        RegoRef.prototype.fullRefString = function (removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
        ...
        RegoRef.prototype.refString = function (removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
            return this.fullRefString(removalPrefixs).replace("\\[_\\]$", "");
        };
        RegoRef.prototype.asCollectionRefs = function (removalPrefixs) {
            if (removalPrefixs === void 0) { removalPrefixs = []; }
            return this.fullRefString(removalPrefixs)
                .split("[_]")
                .map(function (refStr) { return refStr.replace(/^\./, ""); });
        };
        RegoRef.prototype.isOperator = function () {
            return Object.keys(RegoOperators).indexOf(this.fullRefString()) !== -1;
        };
        // --- the first var type won't count as collection lookup
        RegoRef.prototype.hasCollectionLookup = function () {
            if (this.parts.length <= 1)
                return false;
            else {
                return (this.parts.slice(1).findIndex(function (part) { return part.type === "var"; }) !==
                    -1);
            }
        };
        // -- simple collection only contains 1 level lookup
        // -- we don't need Nested Query to handle it
        RegoRef.prototype.isSimpleCollectionLookup = function () {
            if (this.parts.length <= 1)
                return false;
            else {
                return (this.parts.slice(1).findIndex(function (part) { return part.type === "var"; }) ===
        ...
        RegoRef.prototype.isResolveAsCollectionValue = function () {
            var refString = this.fullRefString();
            return refString.lastIndexOf("[_]") === refString.length - 3;
        };
        RegoRef.prototype.asOperator = function () {
            if (this.isOperator())
    ...
    var RegoRuleSet = /** @class */ (function () {
        function RegoRuleSet(parser, rules, fullName, name) {
            ...
            if (rules === null || rules === void 0 ? void 0 : rules.length) {
                var defaultRuleIdx = rules.findIndex(function (r) { return r.isDefault; });
                if (defaultRuleIdx !== -1) {
                    this.defaultRule = rules[defaultRuleIdx];
                }
                this.rules = rules.filter(function (r) { return !r.isDefault; });
            }
            if (fullName) {
            ...
            if (this.rules.length &&
                this.rules.findIndex(function (r) { return !r.hasNoResolvableRef; }) === -1) {
                this.hasNoResolvableRef = true;
            }
            this.evaluate();
        }
        RegoRuleSet.prototype.evaluate = function () {
            var _a;
            if (this.hasNoResolvableRef) {
                return this;
            }
            ...
            this.rules.forEach(function (r) { return r.evaluate(); });
            var matchedRule = this.rules.find(function (r) { return r.isResolvable() && r.isMatched; });
            if (matchedRule) {
                this.isCompleteEvaluated = true;
                this.value = matchedRule.value;
                return this;
            }
            if (this.rules.findIndex(function (r) { return !r.isResolvable(); }) !== -1) {
        ...
        RegoRuleSet.prototype.isResolvable = function () {
            if (!this.isCompleteEvaluated) {
                this.evaluate();
            }
            return this.isCompleteEvaluated;
        };
        RegoRuleSet.prototype.getResidualRules = function () {
            var _this = this;
            if (this.isResolvable()) {
                return [];
            }
            var rules = this.defaultRule
                ? __spreadArray([this.defaultRule], this.rules) : __spreadArray([], this.rules);
            rules = this.rules.filter(function (r) { return !r.isResolvable(); });
            if (!rules.length) {
                return [];
            }
            rules = _.flatMap(rules, function (rule) {
                ...
                var unresolvedExpressions = rule.expressions.filter(function (exp) { return !exp.isResolvable(); });
                ...
                var exp = unresolvedExpressions[0];
                if (exp.terms.length === 1) {
                    var fullName = exp.terms[0].fullRefString();
                    var ruleSet = _this.parser.ruleSets[fullName];
                    if (!ruleSet) {
                        var compressedRule = rule.clone();
                    ...
                    var _a = exp.toOperatorOperandsArray(), operator = _a[0], _b = _a[1], op1 = _b[0], op2 = _b[1];
                    ...
                    var value_1 = op1.isValueResolvable()
                        ? op1.getValue()
                        : op2.getValue();
                    var refTerm = op1.isValueResolvable() ? op2 : op1;
                    var fullName = refTerm.fullRefString();
                    var ruleSet = _this.parser.ruleSets[fullName];
                    if (!ruleSet) {
                        var compressedRule = rule.clone();
                        compressedRule.expressions = [exp];
                    ...
                    var refRules = ruleSet.getResidualRules();
                    // when negated expression, reverse the operator
                    var convertedOperator = exp.isNegated
                        ? operator == "="
                            ? "!="
                            : "="
                        : operator;
                    if (convertedOperator == "=") {
                        refRules = refRules.filter(function (r) { return r.value == value_1; });
                    }
                    else {
                        refRules = refRules.filter(function (r) { return r.value != value_1; });
                    }
     ...
     */
    var OpaCompileResponseParser = /** @class */ (function () {
        function OpaCompileResponseParser() {
            /**
        ...
        OpaCompileResponseParser.prototype.setQueryRuleResult = function (val) {
         ...
         * @memberof OpaCompileResponseParser
         */
        OpaCompileResponseParser.prototype.parse = function (json) {
            var _this = this;
            if (_.isString(json)) {
            ...
            if (this.data.queries.findIndex(function (q) { return !(q === null || q === void 0 ? void 0 : q.length); }) !== -1) {
            ...
            if (queries) {
                if (queries.findIndex(function (ruleBody) { return !ruleBody || !ruleBody.length; }) !== -1) {
                    // --- there is an empty array --- indicates unconditional matched
                    this.setQueryRuleResult(true);
                    return [];
                }
                queries.forEach(function (ruleBody, i) {
                    var rule = new RegoRule({
                        name: _this.pseudoQueryRuleName,
                        fullName: _this.pseudoQueryRuleName,
                        expressions: RegoRule.createExpressionsFromRuleBodyData(ruleBody, _this),
                        isDefault: false,
            ...
            var packages = this.data.support;
            if (packages) {
                packages.forEach(function (p) {
                    if (!_.isArray(p.rules) || !p.rules.length)
                        return;
                    var packageName = p.package && _.isArray(p.package.path)
                        ? RegoRef.convertToFullRefString(p.package.path)
                        : "";
                    var rules = p.rules;
                    rules.forEach(function (r) {
                        var regoRule = RegoRule.parseFromData(r, packageName, _this);
                        //this.originalRules.push(regoRule);
                        //this.rules.push(regoRule);
                        _this.addRule(regoRule);
                    });
                });
            }
            this.ruleDuplicationCheckCache = {};
            _.uniq(this.rules.map(function (r) { return r.fullName; })).forEach(function (fullName) {
                return (_this.ruleSets[fullName] = new RegoRuleSet(_this, _this.rules.filter(function (r) { return r.fullName === fullName; }), fullName));
            });
            this.resolveAllRuleSets();
            return this.rules;
        };
        OpaCompileResponseParser.prototype.addRule = function (rule) {
            this.originalRules.push(rule);
            ...
            var setData = this.ruleDuplicationCheckCache[rule.fullName];
            var _a = rule.toData(); _a.name; _a.fullName; var ruleData = __rest(_a, ["name", "fullName"]);
            var jsonData = JSON.stringify(ruleData);
            var size = setData.size;
        ...
        OpaCompileResponseParser.prototype.isRefResolvable = function (fullName) {
            if (this.completeRuleResults[fullName]) {
                return true;
            }
            var ruleSet = this.ruleSets[fullName];
            if (!ruleSet) {
                return false;
            }
            return ruleSet.isResolvable();
        };
        OpaCompileResponseParser.prototype.getRefValue = function (fullName) {
            var completeResult = this.completeRuleResults[fullName];
            if (completeResult) {
        ...
        OpaCompileResponseParser.prototype.resolveAllRuleSets = function () {
            while (true) {
                var unresolvedSetsNum = Object.values(this.ruleSets).filter(function (rs) { return !rs.isResolvable(); }).length;
                if (!unresolvedSetsNum) {
                    break;
                }
                Object.values(this.ruleSets).forEach(function (rs) { return rs.evaluate(); });
                var newUnresolvedSetsNum = Object.values(this.ruleSets).filter(function (rs) { return !rs.isResolvable(); }).length;
         ...
         * @memberof OpaCompileResponseParser
         */
        OpaCompileResponseParser.prototype.evaluateRule = function (fullName) {
            if (this.completeRuleResults[fullName]) {
         ...
         * @memberof OpaCompileResponseParser
         */
        OpaCompileResponseParser.prototype.evaluate = function () {
         ...
         * @memberof OpaCompileResponseParser
         */
        OpaCompileResponseParser.prototype.evaluateRuleAsHumanReadableString = function (fullName) {
            var result = this.evaluateRule(fullName);
            if (result === null)
                return "null";
            ...
            var parts = result.residualRules.map(function (r) { return r.toHumanReadableString(); });
            if (parts.length > 1) {
                parts = parts.map(function (p) { return "( " + p + " )"; });
            }
            return parts.join("\nOR\n");
        };
        /**
         ...
         * @memberof OpaCompileResponseParser
         */
        OpaCompileResponseParser.prototype.evaluateAsHumanReadableString = function () {
            return this.evaluateRuleAsHumanReadableString(this.pseudoQueryRuleName);
        };
        OpaCompileResponseParser.prototype.reportWarns = function (msg) {
            this.warns.push(msg);
            this.hasWarns = true;
        };
        return OpaCompileResponseParser;
    }());
    function unknown2Ref(unknown) {
        var prefix = unknown.replace(/^input\./, "");
        return "data.partial." + prefix;
    }

    exports.RegoExp = RegoExp;
    exports.RegoOperators = RegoOperators;
